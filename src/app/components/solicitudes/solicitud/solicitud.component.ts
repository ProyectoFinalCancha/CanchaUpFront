...
export class SolicitudComponent {
  ...
  crearSolicitud(solicitudForm: NgForm): void {
    if (solicitudForm.valid) {
      this.solicitudesService
        .crearSolicitud(this.nuevaSolicitud)
        .pipe(
          finalize(() => {
            this.verSolicitud();
  ...
  /*   cancelarSolicitud(instanceId: string, index: number): void {
    ...
    this.solicitudesService.cancelarSolicitud({ id: instanceId }).subscribe(
      (result) => {
  ...
  getHorarioString(horario: Horarios): string {
    switch (horario) {
      case Horarios._18_HS:
        return '18 HS';
      case Horarios._19_HS:
        return '19 HS';
      case Horarios._20_HS:
        return '20 HS';
      case Horarios._21_HS:
        return '21 HS';
      case Horarios._22_HS:
        return '22 HS';
      case Horarios._23_HS:
        return '23 HS';
      default:
